; A program to replace the target in the inout String to change it to replacement string 
.model small
.stack 100h
...
traverse_string:
    ...
    cld                              ; clear the direction flag = 0 (forward)

; ---- Comparing the Target String ---0
inner_loop:
