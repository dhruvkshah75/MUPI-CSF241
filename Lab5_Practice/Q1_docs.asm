...
; we will need to print the character into a newline 
...
.data 
    ...
    newline db 13, 10, '$'   ; 13=CR, 10=LF, $ = End of String 
...
main proc 
    ...
    mov bl, al     ; Move input to BL for safekeeping 
    ; now the character is stored in AL register 

    ; now we move to the next line => this is done the same as when we print a message
    mov ah, 09h  
    lea dx, newline        ; store the address of newline into dx
    int 21h 
